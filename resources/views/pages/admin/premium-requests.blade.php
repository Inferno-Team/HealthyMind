        ...
        <div class="row">
            <div class="col-12" style="z-index:1">
                <div id="no-users-container"
                    style="flex-direction:column;display:{{ count($premiumRequests) > 0 ? 'none' : 'flex' }}">
                ...
                <div class="card mb-4 h-75"
                    style="overflow:auto;min-height:500px;display:{{ count($premiumRequests) == 0 ? 'none' : 'block' }}"
                    id="table-container">
                    <div class="card-header pb-0">
                        <h6>Premium Request Table</h6>
                    </div>
