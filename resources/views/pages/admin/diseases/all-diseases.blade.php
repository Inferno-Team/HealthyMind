...
@section('content')
@include('pages.admin.topnav', ['title' => 'Diseases Table'])
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('diseases.edit.view',['id' => $disease->id]) }}"
                                            class="text-secondary font-weight-bold text-xs " data-toggle="tooltip"
                                            data-original-title="change" data-id="{{ $disease->id }}">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Do you want to delete this disease ?</p>
            </div>
